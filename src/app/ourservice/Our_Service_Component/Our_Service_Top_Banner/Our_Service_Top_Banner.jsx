...
import ServiceTopBannerImg from "../../../../../public/images/Service_Img/service-top-banner-img.png";
import AntiVirusImg from "../../../../../public/images/Service_Img/anti-virus.png";
import ComputerConfigImg from "../../../../../public/images/Service_Img/computer-config.png";
import ComputerTroubleImg from "../../../../../public/images/Service_Img/computer-trouble.png";
import DataBackupImg from "../../../../../public/images/Service_Img/data-backup.png";
import DataRecoveryImg from "../../../../../public/images/Service_Img/data-recovery.png";
import Image from 'next/image';
const Our_Service_Top_Banner = () => {
  return (
    <>
          ...
          <div className="w-full md:w-1/2 order-1 md:order-1 ">
            <div className=" items-center text-center 2xl:ml-48 xl:ml-30 lg:ml-10 md:ml-10 ml-5 lg:pt-10 md:text-left md:pt-0 pt-8 pb-8">
              <p className="xl:text-[70px] lg:text-[50px] md:text-[50px] text-[30px] font-bold text-[#000000]">
                <span className="text-[#4AC8AE]">Services</span> We Are Offering
              </p>
      ...
      <div className="flex items-center justify-center mt-20 relative">
        <input
          type="text"
          placeholder="Search..."
          className="border-solid border-2 border-[#20B486] px-4 py-2 rounded-l-md focus:outline-none focus:border-[#20B486]"
        />

        <button className="bg-[#20B486] hover:bg-[#20B486] text-white font-bold py-2 px-4 rounded-r-md ml-0 border-solid border-2 border-[#20B486]">
          Search
        </button>
      </div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 pb-20 pt-16 mx-auto">
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
              ...
              <div className="mt-4">
                <h2 className="text-[#20B486] title-font text-lg font-medium text-center">
          ...
          <div className="">
            <div className=" flex px-5 items-center justify-center flex-col">
              <div className="text-center lg:w-2/3 w-full">
                ...
                {/* <p className="mb-8 leading-relaxed text-2xl text-black">You can get in touch with us over the phone or by using our online booking portal! We’ll be out to fix your tech issues in a flash!</p> */}
              </div>
            </div>
...
export default Our_Service_Top_Banner
