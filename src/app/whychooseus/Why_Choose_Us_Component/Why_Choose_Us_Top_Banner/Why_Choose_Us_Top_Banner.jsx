...
import WhyChooseBannerImg from "../../../../../public/images/Why_Choose_Us/why-choose-top-banner.png";
...
const Why_Choose_Us_Top_Banner = () => {
  return (
    <>
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl xl:text-[46px] mb-4 font-medium text-gray-900">
              Our <span className="text-[#20B486]">Promise</span>
            </h1>
            <p className="mb-8 leading-relaxed lg:text-xl md:text-lg text-lg">
              Geekify guarantees satisfactory services and happy customers! Our
              geeks are passionate and well versed, led by experienced leaders
              who have years of hands-on experience to all sorts of tech related
              problems that can arise in both personal and business contexts. We
              always handle each client’s problem scenario individually which
              lets us assess and give personalized solution to every single
              client, and we find that this approach leaves our clients the
              happiest!
            </p>
          </div>
        </div>
      ...
      <section className="text-gray-600 body-font bg-[#F0FAF7]">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl xl:text-[46px] mb-4 font-medium text-gray-900">
              How can we <span className="text-[#20B486]">help you?</span>
            </h1>
            <p className="mb-8 leading-relaxed lg:text-xl md:text-lg text-lg">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been the industry's standard dummy text
              ever since the 1500s, when an unknown printer took a galley of
              type and scrambled it to make a type specimen It has survived not
      ...
      <section className=" my-24 ">
        <div className="container mx-auto px-5">
          <h1 className="title-font sm:text-4xl text-3xl xl:text-[46px] mb-4 font-medium text-gray-900">
            Always on <span className="text-[#20B486]">the job</span>
          </h1>
          <p className="mb-8 leading-relaxed lg:text-xl md:text-lg text-lg">
...
export default Why_Choose_Us_Top_Banner
